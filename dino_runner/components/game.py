...
class Game:
    ...
    def update_score(self):
        self.score += 1
        if self.score % 50 == 0 and self.game_speed <= 1000:
            self.game_speed += 1
        elif self.score % 200 == 0 and self.game_speed > 1000 and self.game_speed < 1600:
            self.game_speed += 1
    ...
    def draw_background(self):
        if self.score > 1000  and self.score < 1200 or self.score > 2000 and self.score < 2300 or self.score >3000 and self.score < 3300:
